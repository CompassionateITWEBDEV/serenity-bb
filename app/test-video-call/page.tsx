...
export default function TestVideoCallPage() {
  ...
  const testDirectVideoCall = () => {
    if (!conversationId.trim()) {
      setTestResult("❌ Please enter a conversation ID");
      return;
    }

    // Test direct video call navigation
    const callUrl = `/call/${conversationId}?role=caller&mode=video&peer=test-peer-id&peerName=Test%20Peer&autoAccept=true`;
    window.open(callUrl, '_blank');
    setTestResult("✅ Opening video call in new tab...");
  };
    ...
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-2 text-sm">
          <p>1. Enter a valid conversation ID</p>
          <p>2. Click "Test Patient Call" to simulate a patient initiating a video call</p>
          <p>3. Click "Test Staff Call" to simulate staff initiating a video call</p>
          <p>4. Click "Test Direct Call" to open a video call page directly</p>
