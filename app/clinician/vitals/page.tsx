...
// --- local types/mocks
type Clinician = { id: string; name: string; role: string; subtitle: string; avatar: string };
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-6xl mx-auto px-4 py-6 space-y-6">
        {/* Icon row: core staff set (consistent) + clinician extras */}
        <div className="flex items-center gap-3">
          {/* --- CORE STAFF ICONS (identical to staff pages) --- */}
          ...
          {/* Clinicians (this page) — active and distinct icon */}
