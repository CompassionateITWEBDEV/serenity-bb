...
const InteractiveMap = dynamic(() => import("@/components/interactive-map"), {
  ssr: false,
  loading: () => <div className="h-[420px] w-full animate-pulse rounded-lg border bg-gray-100" />,
});
            ...
            <Card>
              ...
              <CardContent>
                <form className="space-y-6" onSubmit={handleSubmit} noValidate>
                  ...
                  <div><Label htmlFor="phone">Phone Number</Label><Input id="phone" name="phone" type="tel" /></div>
                  <div><Label htmlFor="subject">Subject</Label><Input id="subject" name="subject" /></div>
                  <div><Label htmlFor="message">Message *</Label><Textarea id="message" name="message" className="min-h-[120px]" required /></div>
