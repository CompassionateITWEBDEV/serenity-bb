...
function TabsNav() {
  ...
  return (
    // Why: keep Tabs styling while routing each change to a real URL
    ...
    <ProtectedRoute>
      <SmartAlertProvider>
        <div className="min-h-screen bg-gray-50">
          {patient && <DashboardHeader patient={patient} />}
          ...
          <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            {patient && (
              <>
                ...
                {/* Why: single source of truth for live overview across all tabs */}
