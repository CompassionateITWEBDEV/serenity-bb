...
export default function RealNotificationsPage() {
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-gray-600 mt-2">Live updates from your healthcare system</p>
          </div>
      ...
      <div className="space-y-4">
        {loading ? (
          <div className="bg-white rounded-lg border p-12 text-center">
            ...
            <p className="text-sm text-gray-400">Fetching real-time data from your system</p>
          </div>
        ) : error ? (
          <div className="bg-white rounded-lg border p-12 text-center">
