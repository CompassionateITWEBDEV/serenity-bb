...
export default function BlogPage() {
  const blogPosts = [
    ...
    { id: 2, title: "The Role of Family Support in Recovery", excerpt: "Discover how family involvement can significantly impact the recovery process and learn practical ways to support your loved one's journey.", author: "Michael Chen, LCSW", date: "January 10, 2024", category: "Family Support", readTime: "7 min read" },
    { id: 3, title: "Medication-Assisted Treatment: Breaking Down the Myths", excerpt: "Addressing common misconceptions about MAT and explaining how it provides a safe, effective path to recovery.", author: "Lisa Rodriguez, RN", date: "January 5, 2024", category: "Treatment", readTime: "6 min read" },
    { id: 4, title: "Building Healthy Coping Strategies for Long-term Recovery", excerpt: "Explore evidence-based techniques for managing stress, triggers, and challenges during your recovery journey.", author: "Dr. Sarah Johnson", date: "December 28, 2023", category: "Recovery Tips", readTime: "8 min read" },
    { id: 5, title: "The Importance of Mental Health in Addiction Recovery", excerpt: "Understanding the connection between mental health and addiction, and how integrated treatment approaches lead to better outcomes.", author: "Michael Chen, LCSW", date: "December 20, 2023", category: "Mental Health", readTime: "6 min read" },
    { id: 6, title: "Nutrition and Recovery: Healing Your Body from the Inside Out", excerpt: "Learn how proper nutrition supports the recovery process and discover practical tips for maintaining a healthy diet.", author: "Lisa Rodriguez, RN", date: "December 15, 2023", category: "Wellness", readTime: "5 min read" },
  ]
