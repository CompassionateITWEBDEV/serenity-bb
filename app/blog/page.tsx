...
export default function BlogPage() {
  const blogPosts = [
    {
      id: 1,
      title: "Understanding Lead Poisoning: Signs, Symptoms, and Treatment Options",
      excerpt:
        "Learn about the early warning signs of lead poisoning and how comprehensive treatment can help restore your health and well-being.",
    ...
    },
    {
      ...
      excerpt:
        "Discover how family involvement can significantly impact the recovery process and learn practical ways to support your loved one's journey.",
    ...
    {
      id: 3,
      title: "Medication-Assisted Treatment: Breaking Down the Myths",
      excerpt:
        "Addressing common misconceptions about MAT and explaining how it provides a safe, effective path to recovery.",
    ...
    },
    {
      ...
      excerpt:
        "Explore evidence-based techniques for managing stress, triggers, and challenges during your recovery journey.",
      author: "Dr. Sarah Johnson",
    ...
    },
    {
      ...
      excerpt:
        "Understanding the connection between mental health and addiction, and how integrated treatment approaches lead to better outcomes.",
      author: "Michael Chen, LCSW",
    ...
    },
    {
      ...
      excerpt:
        "Learn how proper nutrition supports the recovery process and discover practical tips for maintaining a healthy diet.",
      author: "Lisa Rodriguez, RN",
