          ...
          {[1, 2, 3, 4].map((step) => (
            <div
              ...
              className={`w-3 h-3 rounded-full ${
                step === currentStep ? "bg-cyan-500" : step < currentStep ? "bg-cyan-300" : "bg-gray-200"
              }`}
            />
          ))}
        </div>
          ...
          {currentStep === 2 && (
            <div className="space-y-4">
              <div>
                ...
                <Textarea
                  id="primaryConcern"
                  placeholder="Please describe your primary concern or reason for seeking treatment"
                  className="min-h-20"
            ...
            <div className="space-y-4">
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-gray-600">
                  ...
                  <p>
                    <strong>Contact Method:</strong> {formData.preferredContactMethod}
                  </p>
                  <p>
                    <strong>Treatment Type:</strong> {formData.treatmentType}
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-3">
                <label className="flex items-start space-x-3">
                  ...
                  <span className="text-sm">
                    I consent to treatment and understand that this information will be used to provide appropriate care
                    *
                  </span>
                </label>
          ...
          <div className="flex justify-between pt-6">
            ...
            <div className="ml-auto">
              {currentStep < totalSteps ? (
                ...
                <Button type="submit" className="bg-indigo-500 hover:bg-indigo-600 text-white px-8">
                  Submit Application
                </Button>
              )}
            </div>
