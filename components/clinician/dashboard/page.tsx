...
import {
  Filter, HeartPulse, Search, Users, MessageSquare,
...
const MOCKS: Clinician[] = [
  { id: "1", name: "Dr. Marlin Cooper", role: "Addiction Recovery Consultant", avatar: "/avatars/1.png" },
  { id: "2", name: "Dr. Sarah Jennings", role: "Substance Abuse Counselor", avatar: "/avatars/2.png" },
  { id: "3", name: "Dr. Emily Roberts", role: "Behavioral Health Specialist", avatar: "/avatars/3.png" },
  { id: "4", name: "Dr. Maria Gonzalez", role: "Rehabilitation Physician (Physiatrist)", avatar: "/avatars/4.png" },
  { id: "5", name: "Dr. Aisha Rahman", role: "Mental Health & Addiction Therapist", avatar: "/avatars/5.png" },
  { id: "6", name: "Dr. John Lee", role: "Addiction Medicine Specialist", avatar: "/avatars/6.png" },
];
            ...
            <Card className="shadow-sm">
              <CardContent className="p-0">
                <ul className="divide-y">
                  {filtered.length === 0 && <li className="px-4 py-8 text-center text-sm text-slate-500">No results.</li>}
                  {filtered.map((c) => (
                    <li key={c.id} className="flex items-center gap-3 px-4 py-3">
                      <div className="h-10 w-10 rounded-full bg-slate-200 overflow-hidden">
                        {/* keep layout stable if avatar missing */}
